...
namespace GymManagement.Web.Pages.Aulas
{
    ...
    public class CreateModel : PageModel
    {
        ...
        public CreateModel(ApiService api, IHttpClientFactory factory, IConfiguration config) { _api = api; _factory = factory; _config = config; }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            {
                Nome = Nome, Categoria = Categoria, DiaSemana = DiaSemana,
                Hora = Hora, DuracaoMinutos = DuracaoMinutos,
                InstrutorId = InstrutorId, SalaId = SalaId
            });
            if (!ok) { ModelState.AddModelError("", "Erro ao criar aula."); await CarregarListas(); return Page(); }
    ...
    public class EditModel : PageModel
    {
        ...
        private readonly IHttpClientFactory _factory;
        private readonly IConfiguration _config;
        public EditModel(ApiService api, IHttpClientFactory factory, IConfiguration config) { _api = api; _factory = factory; _config = config; }
        ...
        public async Task<IActionResult> OnGetAsync(int id)
        {
            ...
            AulaId = id;
            Aula = new AulaCreateDto { Nome = aula.Nome, Categoria = 99, DiaSemana = aula.DiaSemana, Hora = aula.Hora, DuracaoMinutos = aula.DuracaoMinutos };
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            TempData["Sucesso"] = "Aula atualizada.";
            return RedirectToPage("Index");
        }
