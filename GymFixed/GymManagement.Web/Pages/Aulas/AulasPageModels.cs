...
namespace GymManagement.Web.Pages.Aulas
{
    ...
    public class IndexModel : PageModel
    {
        ...
        {
            try { Aulas = await _api.GetAulasAsync(); }
            catch { ModelState.AddModelError("", "Não foi possível carregar as aulas."); }
        }
    }
    ...
    public class EditModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync(int id)
        {
            ...
            // FIX #1/#2: usar InstrutorId, SalaId e CategoriaId reais da aula
            Aula = new AulaCreateDto
            {
                Nome = aula.Nome,
                Categoria = aula.CategoriaId,
    ...
    public class DeleteModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(int id)
        {
            ...
            TempData["Sucesso"] = "Aula eliminada.";
            return RedirectToPage("Index");
        }
    }
